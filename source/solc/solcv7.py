...
class SOLCV7(nn.Module):
    def __init__(self, num_classes, in_ch_sar=1, in_ch_opt=4, atrous_rates=[6, 12, 18]):
        super(SOLCV7, self).__init__()

        self.sar_en1 = _EncoderBlock(in_ch_sar, 64)  # 256->128, 1->64
        ...
        self.opt_en1 = _EncoderBlock(in_ch_opt, 64)  # 256->128, 4->64
