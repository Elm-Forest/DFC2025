...
class FocalLoss(nn.Module):
    """
    Focal Loss for multi-label (multi-channel) binary segmentation with optional label smoothing.
    ---------------------------------------------------
    ...
    label_smoothing: If > 0, apply label smoothing to the labels.
    """

    def __init__(self, alpha=0.25, gamma=2.0, reduction='mean', eps=1e-6, label_smoothing=0):
    ...
    def forward(self, logits, labels):
        ...
        """
        # 1) Apply label smoothing if enabled
